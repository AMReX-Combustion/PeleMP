...
{
  if (lev != 0 || !prob_parm.do_injection) {
    return false;
  }
  ...
  sprayInjection<LogNormDist>(
    log_dist, prob_parm.jet_cent, prob_parm.jet_norm, jet_dia,
    prob_parm.part_temp, mass_flow_rate, jet_vel, prob_parm.spray_angle, dt,
