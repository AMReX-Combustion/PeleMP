  ...
  const amrex_real* probhi)
{
  ...
  pp.query("mach", PeleC::prob_prob_device->mach);
  pp.query("ref_p", PeleC::prob_prob_device->p0);
  pp.query("ref_T", PeleC::prob_prob_device->T0);
  pp.query("init_O2", PeleC::prob_prob_device->Y_O2);
  pp.query("init_N2", PeleC::prob_prob_device->Y_N2);
