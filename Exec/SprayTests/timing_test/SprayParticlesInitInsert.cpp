...
#ifdef USE_SPRAY_SOA
    for (int dir = 0; dir != AMREX_SPACEDIM; ++dir)
      host_real_attribs[ind][m_sprayIndx[SprayComps::pstateVel+dir]].push_back(ProbParm::partVel[dir]);
...
#else
    for (int dir = 0; dir != AMREX_SPACEDIM; ++dir)
      p.rdata(m_sprayIndx[SprayComps::pstateVel+dir]) = ProbParm::partVel[dir];
