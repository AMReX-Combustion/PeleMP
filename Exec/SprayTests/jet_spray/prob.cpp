...
AMREX_GPU_DEVICE_MANAGED amrex::Real inlet_vel = 2320.;
AMREX_GPU_DEVICE_MANAGED amrex::Real jet_vel = 5000.;
AMREX_GPU_DEVICE_MANAGED amrex::Real jet_dia = 0.5;
AMREX_GPU_DEVICE_MANAGED amrex::Real part_dia = 0.001;
  ...
  const amrex_real* probhi)
{
  ...
  pp.query("inlet_vel", ProbParm::inlet_vel);
  pp.query("jet_vel", ProbParm::jet_vel);
  pp.query("part_dia", ProbParm::part_dia);
